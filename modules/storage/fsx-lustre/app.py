...
dra_import_path = os.getenv(_param("DRA_IMPORT_PATH"), None)
dra_export_path = os.getenv(_param("DRA_EXPORT_PATH"), None)
...
stack = FsxFileSystem(
    ...
    dra_import_path=fix_paths(dra_import_path),  # type: ignore
    dra_export_path=fix_paths(dra_export_path),  # type: ignore
