...
# Module Parameters
custom_kernel_name = os.getenv("SEEDFARMER_PARAMETER_CUSTOM_KERNEL_NAME", "")
image_name = os.getenv("SEEDFARMER_PARAMETER_SAGEMAKER_IMAGE_NAME")
app_image_config_name = os.getenv("SEEDFARMER_PARAMETER_APP_IMAGE_CONFIG_NAME")
...
uid = os.getenv("SEEDFARMER_PARAMETER_KERNEL_USER_UID", 1000)
gid = os.getenv("SEEDFARMER_PARAMETER_KERNEL_USER_GID", 100)
mount_path = os.getenv("SEEDFARMER_PARAMETER_KERNEL_USER_HOME_MOUNT_PATH", "/home/sagemaker-user")
...
role_arn = json.loads(cdk_output[app_prefix]["metadata"])["SageMakerCustomKernelRoleArn"]
...
def create_image():
    return sm_client.create_image(
        Description="IDF Generated Image",
